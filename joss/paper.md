...
![X and Z subgraphs of a small listed product code](figures/lp_small.png){ width=20% }
...
![X and Z stabiliser neighbourhoods in the above code](figures/lp_big_sub.png){ width=20% }
