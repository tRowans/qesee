...
![X and Z subgraphs of a small lifted product code](figures/lp_small.png){ width=60% }
...
![Decoding of a 2D surface code](figures/sc_error_sequence.png){ width=60% }
